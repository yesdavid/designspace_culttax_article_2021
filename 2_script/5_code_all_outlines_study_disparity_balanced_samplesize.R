...
##### try to balance out the distribution between the three datasets.
...
width <- 285
# ggsave(whole_grid,
#        filename = "./3_output/whole_grid_resampled.svg",
#        height  = height,
#        width = width,
#        units = "mm")
# ggsave(whole_grid,
#        filename = "./3_output/whole_grid_resampled.png",
#        height  = height,
#        width = width,
#        units = "mm")
